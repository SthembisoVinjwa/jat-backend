drop database jobapptrackerdb;
drop user jobapptracker;
create user jobapptracker with password 'test123';
create database jobapptrackerdb with template=template0 owner=jobapptracker;
\connect jobapptrackerdb;
